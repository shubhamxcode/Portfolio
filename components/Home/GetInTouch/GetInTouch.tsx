...
export default function GetInTouch() {
  ...
  return (
    ...
    >
      ...
      <div className="pt-4">
        {isAndroidWebView ? (
          <a href="https://mail.google.com/mail/?view=cm&to=shubh.varshneycode@gmail.com" target="_blank" rel="noopener noreferrer">
            <button
              className="font-mono text-sm text-AAsecondary border-AAsecondary 
                            px-8 py-4 border-[1.5px] rounded hover:bg-AAsecondary hover:text-AAprimary transition duration-300"
            >
              Say Hello
            </button>
          </a>
