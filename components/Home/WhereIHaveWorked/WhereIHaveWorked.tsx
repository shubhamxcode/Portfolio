...
import AshnaAI from "./Descriptions/AshnaAI";
import GdgNiet from "./Descriptions/GdgNiet";
import Fosscu from "./Descriptions/Fosscu";
...
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("AshnaAI");
