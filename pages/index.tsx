...
export default function Home() {
  ...
  const [IsBlackListEmpty, setIsBlackListEmpty] = useState(
    !process.env.NEXT_PUBLIC_BLACKLIST_COUNTRIES || process.env.NEXT_PUBLIC_BLACKLIST_COUNTRIES === "" ? true : false
  );
  ...
  const meta = {
    title: "Shubham Varshney - Full Stack Developer & Web3 Enthusiast",
    description: `I&apos;m passionate about building impactful digital experiences with code. Specializing in React, Next.js, and Web3 development. Get in touch with me to know more.`,
    image: "/web logo.svg",
    type: "website",
  };
